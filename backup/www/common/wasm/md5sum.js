...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'md5sum.wast';
  var wasmBinaryFile = '/common/wasm/md5sum.wasm';
  var asmjsCodeFile = 'md5sum.temp.asm.js';
